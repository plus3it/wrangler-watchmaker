uri_map = {
  # python for windows
  "https://www.python.org/ftp/python/3.14.4/python-3.14.4-amd64.exe"   = "python/python/"
  "https://www.python.org/ftp/python/3.13.13/python-3.13.13-amd64.exe" = "python/python/"
  ...
  # salt for windows
  "https://packages.broadcom.com/artifactory/saltproject-generic/windows/3007.13/Salt-Minion-3007.13-Py3-AMD64-Setup.exe" = "saltstack/salt/windows/"
  ...
  "s3://wrangler-watchmaker-filecache/spawar/scc/SCC_5.14_Windows_Setup.exe"  = "spawar/scc/"
  "s3://wrangler-watchmaker-filecache/spawar/scc/scc-5.14.rhel8.x86_64.rpm"   = "spawar/scc/"
  "s3://wrangler-watchmaker-filecache/spawar/scc/scc-5.14.rhel9.x86_64.rpm"   = "spawar/scc/"
}
