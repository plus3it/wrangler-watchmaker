uri_map = {
  ...
  # spawar scc
  "s3://wrangler-watchmaker-filecache/spawar/scc/SCC_5.4.2_Windows_Setup.exe" = "spawar/scc/"
  "s3://wrangler-watchmaker-filecache/spawar/scc/scc-5.4.2.rhel7.x86_64.rpm"  = "spawar/scc/"
}
